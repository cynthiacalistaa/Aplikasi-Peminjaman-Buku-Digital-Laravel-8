              ...
              <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        <h5 class="card-title text-primary">Selamat Datang di Perpusta!</h5>
                        <p class="mb-4">Perpustakaan SMK Informatika Utama
                        <br> lebih dari 2.000 koleksi buku tersedia - pinjam sekarang, baca nanti!</p>
            
                        <a href="javascript:;" class="btn btn-sm btn-outline-primary">Cari Buku</a>
                      </div>
                    </div>
